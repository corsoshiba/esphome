...
async def to_code(config):
    ...
    if room_temperature_config := config.get(CONF_ROOM_TEMPERATURE):
        ...
        cg.add(mv.register_micronovaSW_listener(sens))
        ...
        cg.add(sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_ROOM_TEMPERATURE))
    ...
    if fumes_temperature_config := config.get(CONF_FUMES_TEMPERATURE):
        ...
        cg.add(sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_FUMES_TEMPERATURE))
    ...
    if stove_power_config := config.get(CONF_STOVE_POWER):
        ...
        cg.add(sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_STOVE_POWER))
    ...
    if fan_speed_config := config.get(CONF_FAN_SPEED):
        ...
        cg.add(sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_FAN_SPEED))
    ...
    if memory_address_sensor_config := config.get(CONF_MEMORY_ADDRESS_SENSOR):
        ...
        cg.add(
            sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_MEMORY_ADDRESS_SENSOR)
        )
    ...
    if water_temperature_config := config.get(CONF_WATER_TEMPERATURE):
        ...
        cg.add(sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_WATER_TEMPERATURE))
    ...
    if water_pressure_config := config.get(CONF_WATER_PRESSURE):
        ...
        cg.add(sens.set_function(MicroNovaSWFunctions.STOVE_FUNCTION_WATER_PRESSURE))
